...
public class MybatisGeneratorBridge {
    ...
    public void generate() throws Exception {
        ...
        // Swagger 插件
        if (generatorConfig.isUseSwaggerPlugin()) {
            PluginConfiguration pluginConfiguration = new PluginConfiguration();
            pluginConfiguration.addProperty("type", "com.zzg.mybatis.generator.plugins.GeneratorSwagger2Doc");
            pluginConfiguration.setConfigurationType("com.zzg.mybatis.generator.plugins.GeneratorSwagger2Doc");
            context.addPluginConfiguration(pluginConfiguration);
        }
